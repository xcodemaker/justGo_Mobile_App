...
import com.dhammika_dev.justgo.ui.adapters.BookingListAdapter;
...
public class TicketBookingFragment extends BaseFragment implements ScheduleView, BookingListAdapter.OnNoteListener {
    ...
    public static TicketBookingFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((PassengerHomeActivity) getActivity()).hideBackButton(false);
    ...
    public void setAdapter() {
        adapter = new BookingListAdapter(getContext(), listItems, this, trainScheduleResponse);
