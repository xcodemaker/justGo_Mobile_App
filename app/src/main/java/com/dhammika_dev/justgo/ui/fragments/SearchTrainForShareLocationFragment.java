...
public class SearchTrainForShareLocationFragment extends BaseFragment {
    ...
    public SearchTrainForShareLocationFragment() {

    }


    public static SearchTrainForShareLocationFragment newInstance(String param1, String param2) {
        SearchTrainForShareLocationFragment fragment = new SearchTrainForShareLocationFragment();
    ...
    public void openViewTrainSchedule() {
        ...
        if (cheker) {
            ...
            Fragment fragment = new ShareLocationTrainListFragment();
